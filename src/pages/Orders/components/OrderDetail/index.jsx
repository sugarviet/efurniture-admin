...
const OrderDetail = ({ data }) => {
    ...
    const productColumns = [
        ...
        },
        {
            title: 'Color',
            render: (text, record) => (
                <div style={{ width: 20, height: 20, borderRadius: '50%', backgroundColor: record.variation[0].color }}></div>
            ),
        },
        {
            title: 'Quantity',
        ...
        },
        {
            ...
            render: (text, record) => {
                return (
                    <span>
                        {formatCurrency(record.variation[0].sub_price)}
                    </span>
                )
            },
        },
        ...
        <div className='flex flex-col gap-3'>
            <div>
                ...
                <Descriptions bordered column={1}>
                    <Descriptions.Item label="Order Code">{data.order_code}</Descriptions.Item>
                    <Descriptions.Item label="Total">{formatCurrency(data.order_checkout.final_total)}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="Payment Method">{data.payment_method}</Descriptions.Item>
                    <Descriptions.Item label="Shipping Address">{data.order_shipping.address}</Descriptions.Item>
                    <Descriptions.Item label="Shipping Ward">{data.order_shipping.ward}</Descriptions.Item>
                    <Descriptions.Item label="Name">{data.order_shipping.first_name} {data.order_shipping.last_name}</Descriptions.Item>
