...
import FurnitureOptionWarehouse from "../FurnitureOptionWarehouse";
import BriefInfoWithColor from "../BriefInfoWithColor";
  ...
  return (
    <section className="w-full">
        ...
        {value && !multiple && (
          <BriefInfoWithColor
            info={{
              ...
              name: value.name,
              color: value.selectedVariation.value
            }}
            img_class="h-6 w-6"
          />
        )}
      ...
      <AppModal className="h-96" isOpen={modalOpen} setIsOpen={setModalOpen}>
        ...
        <FurnitureOptionWarehouse onSelect={(furniture) => {
